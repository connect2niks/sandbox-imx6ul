...
#define HASH_ALG_SHAKE128_256 \
    "shake128" /**< String macro for SHAKE 128 output 256 */
#define HASH_ALG_SHAKE256_512 \
    "shake256" /**< String macro for SHAKE 256 output 512 */
...
#define MLDSA65_SIG_SIZE 309 /**< ML-DSA65 signature size (bytes) */

/* ML-DSA87 definitions */
#define MLDSA87_PK_SIZE 2592  /**< ML-DSA65 public key size (bytes) */
#define MLDSA87_SK_SIZE 4896  /**< ML-DSA65 secret key size (bytes) */
#define MLDSA87_SIG_SIZE 4627 /**< ML-DSA65 signature size (bytes) */
