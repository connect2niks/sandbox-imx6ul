...
/** Returns key data size in bytes from SRK key size/curve.
 *
 * @param[in] key_size_or_curve SRK key size/cruve identifier.
 *
 * @remark If @a key_size_or_curve contains unknown identifier value 0 is
 *         returned.
 *
 * @retval key data size in bytes.
 */
